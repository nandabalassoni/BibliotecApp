    ...
    <body>
        <div class="container">
            ...
            <?php
				...
				foreach($query_result as $aluno) :
            ?>
                    
            <div class="formulario">
			    <form action="editarAluno.php" method="post" id="editar">
                    <input type="hidden" name="idaluno" value="<?php echo ($aluno['idaluno']); ?>">
                    <label> Nome: </label>
					<input type="text" name="nome" placeholder="Seu nome" value="<?php echo ($aluno['nome']); ?>">
					<br><br>
					<label> RA: </label>
					<input type="text" name="ra" placeholder="Seu endereco" value="<?php echo ($aluno['ra']); ?>" >
					<br><br>
					<label> CPF:</label>
					<input type="text" name="cpf" placeholder="Seu telefone" value="<?php echo ($aluno['cpf']); ?>" >
					<br><br>
            ...
            <div class="row">
                <div class="col-md-12" id="voltarEditar">
                    <a href="aluno.php"><button type="button" class="btn btn-outline-danger btn-lg btn-block" id="button">voltar</button></a>
                </div>
            </div>
    </div>
