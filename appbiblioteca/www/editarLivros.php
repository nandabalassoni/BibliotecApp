    ...
    <body>
        <div class="container">
            ...
            <?php
				...
				foreach($query_result as $livro) :
            ?>
                    
            <div class="formulario">
			    <form action="editarLivros1.php" method="post" id="editar">
                    <input type="hidden" name="idlivro" value="<?php echo ($livro['idlivro']); ?>">
                    <label> Título: </label>
					<input type="text" name="titulo" placeholder="Título" value="<?php echo ($livro['titulo']); ?>">
					<br><br>
					<label> Gênero: </label>
					<input type="text" name="genero" placeholder="Genero" value="<?php echo ($livro['genero']); ?>" >
					<br><br>
					<label> Autor(a):</label>
					<input type="text" name="autor" placeholder="Autor(a)" value="<?php echo ($livro['autor']); ?>" >
					<br><br>
            ...
            <div class="row">
                <div class="col-md-12" id="voltarEditar">
                    <a href="livros.php"><button type="button" class="btn btn-outline-danger btn-lg btn-block" id="button">voltar</button></a>
                </div>
            </div>
    </div>
